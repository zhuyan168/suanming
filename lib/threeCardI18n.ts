const zh = {
  ...
  question: {
    ...
    h1: '三张牌万能牌阵',
    intro: '不知道该选哪个牌阵？从这个开始就可以。',
    detail: '感情、工作、生活，几乎任何问题都可以问。三张牌会围绕你的问题，给出一个简单、直接的整体解读，帮你先看看事情大概是什么情况。',
    scope: '如果你只想快速了解一下，选这个就够了。如果你想深入分析双方的想法、事情背后的原因、多个影响因素或长期发展，建议选择牌数更多的深度牌阵。',
    label: '你的问题（可选）',
...
const en: typeof zh = {
  ...
  question: {
    ...
    intro: 'Not sure which spread to choose? This is a good place to start.',
    detail: 'You can ask about almost anything, including love, work, or everyday life. The three cards give you a simple, direct overview of your question, so you can quickly understand the general situation.',
    scope: 'Choose this spread when you only need a quick overview. If you want to explore both sides of a relationship, underlying causes, multiple influences, or long-term development, a larger in-depth spread may be more suitable.',

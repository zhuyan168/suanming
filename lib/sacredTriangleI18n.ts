const zh = {
  ...
  question: {
    ...
    h1: '圣三角牌阵',
    intro: '知道问题是什么，却不知道该怎么解决？可以选这个牌阵。',
    detail: '三张牌会帮你顺着问题往下看：这件事为什么会变成现在这样、你目前具体卡在哪里，以及接下来可以先做什么。',
    scope: '它适合你已经有一个明确的问题，并且想进一步了解问题的原因和下一步行动。如果你只是想快速看看一件事目前的大致情况，不需要分析太多细节，三张牌万能牌阵会更合适。',
    label: '你的问题（可选）',
...
const en: typeof zh = {
  ...
  question: {
    ...
    intro: 'Know what the problem is but not how to handle it? This spread can help.',
    detail: 'The three cards help you follow the problem step by step: how the situation developed, what is currently holding you back, and what you can do next.',
    scope: 'Choose this spread when you have a clear question and want to understand its cause and what to do next. If you only want a quick overview of the situation without exploring too many details, the Three-Card Universal Spread may be a better fit.',

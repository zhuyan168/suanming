const zh = {
  ...
  result: {
    ...
    reminderTitle: '温柔提醒',
    reminderText: '二选一牌阵属于会员解读内容。你可以先根据每张牌的牌位提示，自己感受两条选择带来的状态与走向；如果你希望获得更细致的对比分析与行动建议，可以点击下方「开始解读」解锁 AI 深度解读。',
...
const en: typeof zh = {
  ...
  result: {
    ...
    reminderText: 'The Two Choices spread is a member reading. You can first reflect on what each card\'s position reveals about each path. For a detailed comparison and action guidance, tap "Get Reading" below to unlock the AI deep reading.',

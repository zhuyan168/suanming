                    ...
                    {reading.cards.map((cardReading, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`flex flex-col md:flex-row gap-6 border rounded-2xl p-6 hover:bg-white/8 transition-colors ${
                            isGuidanceCard 
                            ...
                            <div className="flex items-center gap-3 flex-wrap">
                              <span
                                className={`text-lg font-bold ${
                                  isGuidanceCard ? 'text-yellow-400' : 'text-primary'
                                }`}

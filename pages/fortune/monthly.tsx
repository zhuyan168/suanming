...
export default function MonthlyFortune() {
  ...
  const texts = isEn ? {
    ...
    subtitle: 'Choose the free version for a quick monthly overview, or the paid version for separate insights into career, love, money, and more.',
    basicTitle: 'Three-Card Monthly Reading',
    basicSubtitle: 'Quickly see the month\'s main theme, likely obstacle, and direction worth following.',
    basicButton: 'Start Free Reading',
    memberTitle: 'Seven-Card Monthly Deep Dive',
    memberSubtitle: 'Plan the month with separate insights into your overall state, career, love, money, relationships, month-end shift, and next steps.',
    ...
    sectionLabel: '月度运势',
    h1: '本月你的命运走向如何？',
    subtitle: '想快速了解本月整体运势，选免费版；想分别查看事业、感情、金钱等领域，选付费版。',
    basicTitle: '三张牌月度运势（免费）',
    basicSubtitle: '快速查看本月的主要状态、需要注意的阻力，以及值得把握的方向。',
    basicButton: '开始占卜',
    memberTitle: '月度运势深度解析（付费）',
    memberSubtitle: '分别分析整体状态、事业、感情、金钱、人际、月底变化和行动建议。',

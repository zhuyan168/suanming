...
const SPREAD_NAME: Record<string, string> = {
  ...
  'love-future-lover': '我未来的恋人在哪里？',
  'love-what-they-think': 'TA 是怎么看我的？',
  'love-relationship-development': '我们会在一起吗？',
  'love-reconciliation': '我们还会复合吗？',
  'career-skills-direction': '我适合往哪个方向发展？',
  'career-job': '我应该找什么样的工作',
  'career-interview-exam': '这次面试或考试，我要注意什么？',
  'career-offer-decision': '这个 Offer 我该接吗？',
  'career-stay-or-leave': '这份工作，我该留下还是离开？',
  'wealth-current-status': '我现在的财运怎么样？',
  'wealth-obstacles': '是什么挡住了我的财运？',
}

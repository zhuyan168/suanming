...
- overall：综合运势，300字左右，深入解读三张牌组合的能量流动，给出具体的生活建议。
- love：爱情运势，100字左右，针对单身和有伴侣的情况分别给出建议。
- career：事业和学业运势，100字左右，结合具体的牌义给出职业发展或学业上的指引。
- wealth：财运，80字左右，给出具体的理财建议或注意点。
- health：健康建议，80字左右，关注身心平衡。
- luckyColor：幸运色，中文颜色名称即可
- luckyNumber：幸运数字，1～99之间
- quote：幸运箴言，不超过30个字，富有哲理且温暖治愈，需要和整体运势呼应
- card1Meaning：第一张牌的详细解读（结合其在三张牌中的位置），80字左右
- card2Meaning：第二张牌的详细解读（结合其在三张牌中的位置），80字左右
- card3Meaning：第三张牌的详细解读（结合其在三张牌中的位置），80字左右

...
export default function MembershipPage() {
  ...
  const texts = isEn ? {
    ...
    metaDesc: 'Unlock advanced spreads and a richer divination experience.',
    heading: 'Membership',
    subtitle: 'Unlock advanced spreads and a richer divination experience.',
    alreadyMember: 'You are already a member.',
    memberExpires: 'Membership expires on:',
    notMember: 'Your account does not have an active membership. Redeem a code or subscribe to enjoy member benefits.',
    ...
    paymentComingSoon: 'Payment options coming soon.',

...
export default function MembershipPage() {
  ...
  const texts = isEn ? {
    ...
    loginPrompt: 'You can review all prices first. Continue is only required when you subscribe or redeem a code.',
    loginBtn: 'Continue',
    ...
    subscribe: 'Subscribe',
    signInToSubscribe: 'Continue to subscribe',
    checkoutLoading: 'Opening...',
    checkoutLoginPrompt: 'Please continue before purchasing membership.',
    ...
    loginPrompt: '你可以先查看全部价格。只有订阅或兑换会员码时才需要继续登录。',
    loginBtn: '继续',
    benefitsTitle: '会员权益',
    ...
    subscribe: '订阅',
    signInToSubscribe: '继续后订阅',
    checkoutLoading: '打开中...',
    checkoutLoginPrompt: '请先继续登录后再开通会员。',

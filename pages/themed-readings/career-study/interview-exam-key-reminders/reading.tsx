...
const SLOT_CONFIG = [
  { id: "p1", name: "你现在最不确定的地方", meaning: "我对这次考核最不确定的地方是什么？" },
  { id: "p2", name: "你现在的优势在哪里", meaning: "我目前最明显的优势在哪里？" },
  { id: "p3", name: "事情目前的整体走向", meaning: "事情现在大概会朝什么方向发展？" },
  { id: "p4", name: "目前可能影响你的地方", meaning: "有什么因素会影响我的表现？" },
